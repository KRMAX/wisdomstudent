<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<div style="width:700px;max-width:800px;margin:0 auto; ">
    <div style="padding:10px 40px;">
        <div style="margin-bottom:10px;float:left;width:250px;">
            <input class="easyui-textbox" label="学生姓名:" labelPosition="left" data-options="prompt:'请输入学生姓名'" style="width:100%;">
        </div>
        ...
        <div style="padding:10px 40px;">
            <div style="margin-bottom:10px;float:left;width:250px;">
                <input class="easyui-combobox" id="clazz" style="width:100%;" data-options="
...
<div class="normal_main">
    ...
    <div class="datagrid_area">
        <table id="studentdg" title="学生列表" class="easyui-datagrid" style="width:100%;height:500px;"
               url="getStudentDatagrid"
               toolbar="#toolbar" pagination="true" striped="true"
               rownumbers="true" fitColumns="true" singleSelect="true">
            <thead>
            <tr>
                <th field="id" width="20">学生id</th>
                <th field="studentno" width="30" style="border:0px;">学号</th>
                <th field="name" width="30" style="border:0px;">学生姓名</th>
                <th field="sex" width="30" style="border:0px;">性别</th>
                <th field="clazz" width="20">所属班级</th>
                <th field="department" width="20">所属班级</th>
                <th field="admissionYear" width="20">入学年度</th>
            </tr>
            </thead>
        </table>
        <div id="toolbar">
            <a href="javascript:void(0);" class="easyui-linkbutton c3" iconCls="icon-add" plain="false" onclick="addClazz();">添加学生</a>
            <a href="javascript:void(0)" class="easyui-linkbutton c3" iconCls="icon-edit" plain="false" onclick="editClazz();">修改学生</a>
            <a href="javascript:void(0)" class="easyui-linkbutton c3" iconCls="icon-remove" plain="false" onclick="destroyClazz();">删除学生</a>
            ...
            <a href="javascript:void(0);" class="easyui-linkbutton c7" iconCls="icon-add" plain="false"  onclick="openUploadClazz();">批量添加学生</a>
        </div>
    </div>
    <!-- 以下是隐藏控件[begin] -->
        ...
        <form id="fm" method="post">
            <div class="fitem">
                ...
                <input id="studentName" name="studentName" class="easyui-textbox"
                       data-options="prompt:'请输入学生名称...'" required="true">
            </div>
            <div class="fitem">
                <label>所属学院</label>
