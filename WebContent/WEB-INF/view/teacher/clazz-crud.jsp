...
<div style="width:700px;max-width:800px;margin:0 auto; border:1px dotted red;">
	...
	<div  style="padding:10px 35%;">
		<div href="javascript:FindData();" class="easyui-linkbutton"  data-options="iconCls:'icon-search'" style="width:80%;height:24px;outline:0;">查 询</div>
	</div>
</div>
