...
<body class="easyui-layout">
    	...
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
        	<div title="快捷菜单" data-options="iconCls:'icon-application-cascade'" style="padding:5px;">  	
    			<ul class="easyui-tree cexo-side-tree">
                    ...
                    <li iconCls="icon-users"><a href="javascript:void(0)" data-icon="icon-users" data-link="<%=contextPath %>/teacher/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/manageClazz" iframe="1">班级管理</a></li>
                    <li iconCls="icon-user-group"><a href="javascript:void(0)" data-icon="icon-user-group" data-link="<%=contextPath %>/teacher/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/homeworkManage" iframe="1">生成作业内容</a></li>
                    <li iconCls="icon-book"><a href="javascript:void(0)" data-icon="icon-book" data-link="<%=contextPath %>/teacher/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/questImport" iframe="1">数学试题导入</a></li>
    ...
    <div data-options="region:'center'">
        <div id="cexo-tabs" class="easyui-tabs" data-options="border:false,fit:true,plain:true,narrow:true,pill:true,justified:true">  
