    	...
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
        	<div title="快捷菜单" data-options="iconCls:'icon-application-cascade'" style="padding:5px;">  	
    			<ul class="easyui-tree cexo-side-tree">
                	<li iconCls="icon-chart-organisation"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="keyword" iframe="1">关键字管理</a></li>
                    <li iconCls="icon-users"><a href="javascript:void(0)" data-icon="icon-users" data-link="<%=contextPath %>/admin/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/manageClazz" iframe="1">班级管理</a></li>
                    <li iconCls="icon-user-group"><a href="javascript:void(0)" data-icon="icon-user-group" data-link="<%=contextPath %>/admin/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/open-course-selecting" iframe="1">选课管理</a></li>
					<li iconCls="icon-user-group"><a href="javascript:void(0)" data-icon="icon-user-group" data-link="<%=contextPath %>/admin/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/studentManager" iframe="0">学生管理</a></li>
					<li iconCls="icon-book"><a href="javascript:void(0)" data-icon="icon-book" data-link="<%=contextPath %>/admin/${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}/questImport" iframe="1">数学试题导入</a></li>
...
<div id="tabsMenu" class="easyui-menu" style="width: 30px; display: none;">  
	<!--放置一个隐藏的菜单Div-->  
