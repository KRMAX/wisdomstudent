...
<div class="normal_main">
    ...
    <div id="toolbar">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton c3" iconCls="icon-edit" plain="false" onclick="editClazz();">修改作业</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c3" iconCls="icon-remove" plain="false" onclick="destroyClazz();">删除作业</a>
    </div>
</div>
<!-- 打开隐藏作业窗口 -->
<div id="wHomework" class="easyui-dialog" title="新建作业题" 
	data-options="iconCls:'icon-save',closed:true,draggable:true,
        modal:true" style="width:80%;height:80%;padding:10px 20px">
